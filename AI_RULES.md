...
- **Rozwiązanie (CMS)**: Stworzono prosty panel administracyjny (`api/admin.php`) zabezpieczony logowaniem Google OAuth (`oauth_callback.php`), umożliwiający ręczne dodawanie aktualności do bazy.
