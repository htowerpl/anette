...
- **Rozwiązanie (CMS)**: Stworzono prosty panel administracyjny (`admin.php`) zabezpieczony logowaniem Google OAuth (`oauth_callback.php`), umożliwiający ręczne dodawanie aktualności do bazy.
